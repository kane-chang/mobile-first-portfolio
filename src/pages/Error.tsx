...
const Error = () => {
  useGSAP(() => {
    let startErrorTl = gsap.timeline();
    startErrorTl.to("#gradientBg3", {
      "--color1": "97,97,97",
      duration: 4,
      ease: "power1.out",
    });
  ...
  return (
    <>
      ...
      <div
        className="h-svh md:h-screen flex items-center justify-center pb-6 px-6 md:px-16 lg:px-36 xl:px-60"
        id="error-page"
      >
        <div
        ...
        >
          <h1 className="text-white font-inter font-bold text-3xl md:text-4xl xl:text-5xl">
            404: The page is taking a breather in the digital abyss
          </h1>
          <p className="text-white font-inconsolata text-xl md:text-2xl font-bold">
            Oops, the page could not be found. Head back home to resume browsing
            or{" "}
            <a
